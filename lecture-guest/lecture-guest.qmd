...
The [**"analyst"**]{.red22} analyses the data after the data is collected.
...
::: {.f-headline style="padding-left:20%;padding-right:20%;text-align:center;"}
...
`r stat(200, other = 'class="fl"')` `r analyst(200, flip = TRUE, other = "align='right'")`
